...
import {
	...
	type ReadinessCheckSwarm,
	ReadinessCheckSwarmSchema,
...
export const applications = pgTable("application", {
	...
	readinessCheckSwarm: json("readinessCheckSwarm").$type<ReadinessCheckSwarm>(),
...
const createSchema = createInsertSchema(applications, {
	...
	readinessCheckSwarm: ReadinessCheckSwarmSchema.nullable(),
